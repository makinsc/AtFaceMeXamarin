...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "ATFaceME.Xamarin.Droid.dll" comes first in this list. */
		"ATFaceME.Xamarin.Droid.dll",
		"ATFaceME.Xamarin.Core.dll",
		"ExifLib.dll",
		"FFImageLoading.dll",
		...
		"ApiBackend.Transversal.DTOs.PLC.dll",
		"ATFaceME.Xamarin.ServiceBus.dll",
	};
